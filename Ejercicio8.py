...
def procesar_codigo(entrada_codigo, etiqueta_resultado):
    codigo = Cuit(entrada_codigo.get())
    if (codigo.is_valid()):
        etiqueta_resultado.configure(text="El CUIT/CUIL es válido.")
    else:
        etiqueta_resultado.configure(text="El CUIT/CUIL no es válido.")
